...
namespace StatsDirect.Builtins
{
    ...
    { 
        ...
        { 
            ...
            IList<System.Drawing.Image> imageList = ch.x_plgraph( h, s, stime, dead, groups, cnx, glab, useTics, useMarkers ); 
            ParameterBag outputParameters = new ParameterBag(); 
            ...
            { 
                ...
                chartParameters.AddOutput( "chart", host.ImageToRtf( i ) ); 
            }
            return new StepResult( StepSuccess.Success, outputParameters ); 
        } 
        ...
        private static void x_plprep( ref double[,] ARR2, ref ColumnData[] CDAT1, ref double[,] stime, ref int[,] dead, ref int[] nat, ref int[] cen, ref int[] gnx, out int nx, ref int lap, out int nt, ref int[] allcens, ref double[] alltime ) 
        {
            ...
            { 
                ...
                { 
                    ...
                    Q[j] = new Trisvar
                               {TM = ARR2[1, j], gp = Convert.ToInt32(ARR2[0, j]), cs = Convert.ToInt32(ARR2[2, j])};
                } 
            } 
        ...
        public static StepResult RptFollowUpLifetable( ITemplateHost host, ParameterBag parameters ) 
        {
            ...
            { 
                ...
                { 
                    nx = nx + 1;
                    qx[j] = new Trisvar
                                {TM = Math.Floor(t[j]), gp = Convert.ToInt32(w[j]), cs = Convert.ToInt32(D[j])};
                } 
            } 
