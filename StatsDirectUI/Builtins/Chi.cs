    ...
    { 
        ...
        { 
            ...
            { 
                ...
                orParameters.AddOutput( "lb", Meta.get_meta_label( host, o, i, false, cced, title ) ); 
        ...
        { 
            ...
            StepResult outputResult = Tables.s_chi( host, ref cco, a, rows, cols, out abort, true ); 
            if ( abort ) 
            { 
                host.Error( "Error in calculation.", "StatsDirect" ); 
                throw new TemplateOperationCancelledException(); 
            } 
            return outputResult; 
        } 
