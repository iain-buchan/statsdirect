...
namespace StatsDirect.Builtins
{
    ...
    { 
        ...
        { 
            x_preprocess_kwt( x, lx, L, cols, ref t, ref w1, out fault ); 
            x_run_kwt( w1, lx, L, cols, out h, ref ha, t ); 
        } 
        ...
        ///  <remarks></remarks>
        private static void x_run_kwt( double[] w1, int lx, int[] L, int cols, out double h, ref double ha, double t ) 
        { 
        ...
        ///  <remarks></remarks>
        private static void x_preprocess_kwt( double[] x, int lx, int[] L, int cols, ref double t, ref double[] w1, out int fault ) 
        { 
            int i; 
        ...
        public static void x_qci( ref double qc, ref int rx, ref double[] r, ref double xq, ref double GAMMA, out double ll, out double ul, ref double cover, ref bool conservative, ref bool cap_upper, ref bool cap_lower, out int fault ) 
        {
        ...
        private static void x_invu( int n2, int n1, double GAMMA, ref double lev, ref int k, out bool fault ) 
        {
            ...
            x_udist( n2, n1, ref frqncy, ref lfr, ref work, ref lwrk, out fault ); 
            for ( Q=1; Q <= lfr; Q++ ) 
            { 
        ...
        private static void x_udist( int M, int N, ref double[] frqncy, ref int lfr, ref double[] work, ref int lwrk, out bool fault ) 
        {
            fault = true;
            try 
            { 
        ...
        /// </remarks>
        private static void x_mwup_nt_ltp( int n1, int n2, int iv, out double P ) 
        { 
            int j;
            int i;
            int m2; int m1;
        ...
        private static double x_mwup_nt( int n1, int n2, double u ) 
        {
            double P = 0;
            bool fault; 
        ...
        private static double x_mwup_ti( int n1, int n2, double[] ranks, double u ) 
        { 
            double P = 0;
        ...
        private static double x_xmdn( double[] x, int nx, int n1, int n2 ) 
        {
            int N; int j; 
            double[] ax; 
        ...
        private static double x_chance( int v, int N ) 
        {
            double P;
            int i;
        ...
        private static void x_wsr( ref double[] x, ref double[] y, ref int N, ref double w, ref int n1, ref double P, ref double ned, ref double xf, out bool fault ) 
        { 
            int i;
            int k;
            ...
            { 
                ...
                { 
                    ...
                    P = x_chance( ix, n1 ) / ( Math.Pow( 2.0, Convert.ToDouble( n1 ) ) ); 
                } 
            } 
            fault = false; 
        } 
        ...
        private static void x_srk( ref int Sizei, ref double GAMMA, out int k, out double lev ) 
        {
            ...
            double P = x_chance( ix, Sizei ) / ( Math.Pow( 2.0, Sizei ) ); 
            if ( P > 0.5 )
            { 
                P = 1.0 - P; 
            } 
        ...
        private static ParameterBag x_srcon( ITemplateHost host, int size, int k, double[] x, double[] y ) 
        {
            double median = 0; double kl = 0;
            int occurences;
            int midl;
        ...
        { 
            ...
            outputParameters.AddOutput( "median_1", Host.RoundU( x_xmdn( x, N, n1, 1 ) ) ); 
            ...
            outputParameters.AddOutput( "median_2", Host.RoundU( x_xmdn( x, N, n1, n2 ) ) ); 
            ...
            { 
                ...
                { 
                    ...
                    pl = xf == 0 ? x_mwup_nt( n1, n2, u ) : x_mwup_ti( n1, n2, w1, u );
        ...
        public static StepResult RptWilcoxon( ITemplateHost host, ParameterBag parameters ) 
        {
            ...
            x_wsr( ref x, ref y, ref N, ref w, ref n1, ref P, ref ned, ref xf, out fault ); 
            ...
            { 
                ...
                double lev;
                int k;
                x_srk( ref N, ref GAMMA, out k, out lev );
                ParameterBag confParameters = x_srcon( host, N, k, x, y ); 
        ...
        public static StepResult RptQuantile( ITemplateHost host, ParameterBag parameters ) 
        {
            ...
            { 
                ...
                int fault; 
                x_qci( ref qc, ref rx, ref r, ref xq, ref GAMMA, out ll, out ul, ref cover, ref do_conservative, ref cap_upper, ref cap_lower, out fault ); 
        ...
        { 
            ...
            x_preprocess_kwt( x, lx, l, cols, ref t, ref w1, out ifault ); 
            
            double actualh; //  Without ties
            double actualha = 0; //  With ties
            x_run_kwt( w1, lx, l, cols, out actualh, ref actualha, t );
