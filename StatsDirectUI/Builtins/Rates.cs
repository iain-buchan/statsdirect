...
namespace StatsDirect.Builtins
{
    public static class Rates
    {
        ...
        public static ParameterBag RptRateSmr(ITemplateHost host, ParameterBag parameters)
        {
            ...
            DoubleVariable ratesVariable = data.Variables[0]as DoubleVariable;
            DoubleVariable timesVariable = data.Variables[1]as DoubleVariable;
        ...
        public static ParameterBag RptStdrr(ITemplateHost host, ParameterBag parameters)
        {
            ...
            double[] rkw = new double[k + 2 + 1 /* VB to C# conversion */ ];
            ...
            chartParameters.AddOutput("chart", ChartRendererFactory.PlotCorrelationAndReturnRtf(k + 2, title, rkr, rkrl, rkru, rkw, pg, "Stratified rate ratio plot (direct standardization)", "rate ratio (" + Formatting.XRound(cco * 100, 1) + "% confidence interval)", Transformation.Log, false));
