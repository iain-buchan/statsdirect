...
namespace StatsDirect.Builtins
{
    ...
    { 
        ...
        private static void MXSRT2( double[] x, int nrx, int ncx, int nkey, int[] iperm, double[] WK, int[] istk, int ix1, int ix2 ) 
        {
            ...
            do 
            {
                ...
                { 
                    ...
                    { 
                        ...
                        { 
                            ...
                            { 
                                ij = ncx - i + 2;
                                mxsrt3(kr, x, irowx + (ij - 2) * nrx - 1, x, irowx + (ij - 1) * nrx - 1, out kompar); 
                                if ( kompar == 0 ) 
                                { 
                                    if ( iperm[ ij ] < 0 )
                                    { 
                ...
                { 
                    ...
                    int l = j;
                    mxsrt3(kr, x, irowx + (j - 1) * nrx - 1, WK, irowx - 1, out kompar); 
                    if ( kompar != 1 & kompar != 0 ) 
                    { 
                        for ( ii=1; ii <= nr1; ii++ ) 
                        { 
                    ...
                    { 
                        ...
                        mxsrt3(kr, x, irowx + (l - 1) * nrx - 1, x, irowx + (k - 1) * nrx - 1, out kompar); 
                        if ( kompar != 0 ) 
                        { 
                            for ( ii=1; ii <= nr1; ii++ ) 
                            { 
        ...
        ///  <param name="sy"></param>
        ///  <param name="ix2"></param>
        ///  <param name="kompar"></param>
        ///  <remarks></remarks>
        private static void mxsrt3( int n, double[] sx, int ix1, double[] sy, int ix2, out int kompar ) 
        { 
            kompar = 0; 
            int ix = 1; 
            int iy = 1; 
