...
namespace StatsDirect.Templates
{
    ...
    public interface IUserInterface
    {
        ...
        ParameterBag FillAndValidateCombinedParameters(ParameterBag context);
        ...
        /// <exception cref="TemplateOperationCancelledException">if the user cancels the acquisition of the parameter</exception>
        ParameterBag FillParameter(Parameter parameter, ParameterBag context, bool shouldCombine);
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        void PrepareParameter(Parameter parameter, ParameterBag context);
