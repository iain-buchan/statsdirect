...
namespace StatsDirect.Data
{
    ...
    { 
        ...
        // TRANSMISSINGCOMMENT: Property OriginForXml
        ...
        { 
            get 
            { 
                throw new InvalidCastException( "Cannot cast variable to ClassifierVariable" ); 
            } 
        } 
        ...
        { 
            get 
            { 
                throw new InvalidCastException( "Cannot cast variable to DateVariable" ); 
            } 
        } 
        ...
        { 
            get 
            { 
                throw new InvalidCastException( "Cannot cast variable to DoubleVariable" ); 
            } 
        } 
        ...
        { 
            get 
            { 
                throw new InvalidCastException( "Cannot cast variable to StringVariable" ); 
            } 
        } 
