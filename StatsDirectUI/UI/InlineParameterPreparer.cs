...
namespace StatsDirect.UI
{
    ...
    internal class InlineParameterPreparer : IParameterVisitor
    {
        ...
        public void Visit(ConfidenceIntervalParameter parameter)
        {
            ...
            {
                FilledParameter = FilledParameter.Input(SdApplication.SoleInstance.Preferences.DefaultConfidenceInterval);
                return;
            }
        ...
        public void Visit(ChartOptionsParameter parameter)
        {
            ...
            if (null == ctl)
            {
                ...
                FilledParameter = FilledParameter.Input(parameter.ChartDefinition);
                return;
            }
