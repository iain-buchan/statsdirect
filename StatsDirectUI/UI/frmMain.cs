...
namespace StatsDirect.UI
{
    public partial class frmMain : Form, IToolStripHost
    {
            ...
            try
            {
                ...
                foreach (Parameter parameter in outstandingParameters)
                {
                    ...
                    else
                    {
                        ...
                        outputParameters.Add(parameter.Name, preparer.FilledParameter);
                    }
                }
        ...
        /// <returns></returns>
        internal TableLayoutPanel GetUserInputTableForColumn(int column)
        {
            TableLayoutPanel tlp = GetUserInputTable();
        ...
        {
            IntegratedConfidenceIntervalControlVisible = false;
            cboConfidenceInterval.Tag = null;
            if (HasUserInputTable())
            {
