...
namespace StatsDirect.UI
{
    ...
    internal class InlineParameterValueExtractor : IParameterVisitor
    {
        ...
        public void Visit(ConfidenceIntervalParameter parameter)
        {
            ...
            OutputParameters[parameter.Name] = FilledParameter.Input(value);
        }
        ...
        public void Visit(Double2By2Parameter parameter)
        {
            ...
            if (tl != Constant.MISSING)
                OutputParameters[parm.TopLeftName] = FilledParameter.Input(tl);
            if (tr != Constant.MISSING)
                OutputParameters[parm.TopRightName] = FilledParameter.Input(tr);
            if (bl != Constant.MISSING)
                OutputParameters[parm.BottomLeftName] = FilledParameter.Input(bl);
            if (br != Constant.MISSING)
                OutputParameters[parm.BottomRightName] = FilledParameter.Input(br);
        }
        ...
        public void Visit(DoubleParameter parameter)
        {
            ...
            // If we get here, it's OK.
            OutputParameters[parameter.Name] = isMissing ? null : FilledParameter.Input(value);
        }
        ...
        public void Visit(FrameParameter parameter)
        {
            ...
            OutputParameters[parameter.Name] = FilledParameter.Input(frame);
        }
        ...
        public void Visit(OptionsParameter parameter)
        {
            ...
            foreach (Control c in optionsPanel.Controls)
            {
                ...
                else
                {
                    ...
                    OutputParameters[oo.Name] = FilledParameter.Input(chk.Checked);
                }
            }
        }
        ...
        public void Visit(PickVariablesParameter parameter)
        {
            ...
            OutputParameters[parameter.Name] = FilledParameter.Input(ary);
        }

        public void Visit(StringParameter parameter)
        {
            TextBox txt = (TextBox)Control;
            OutputParameters[parameter.Name] = FilledParameter.Input(txt.Text);
        }
        ...
        public void Visit(PickFromListParameter parameter)
        {
            ...
            if (p.AllowMultiple)
            {
                ...
                OutputParameters[parameter.Name] = FilledParameter.Input(selected);
            }
            else
            {
                int offset = p.IncludeNoneEntry ? 1 : 0;
                ...
                case OptionFormatType.Dropdown:
                    {
                        ...
                        OutputParameters[parameter.Name] = FilledParameter.Input(selectedOption.Value);
                    }
                    break;
                case OptionFormatType.Radio:
                    {
                        ...
                        foreach (Control c in optionPanel.Controls)
                        {
                            ...
                            if (rad.Checked)
                            {
                                OutputParameters[parameter.Name] = FilledParameter.Input(rad.Tag);
        ...
        public void Visit(EditGridParameter parameter)
        {
            ...
            OutputParameters[parameter.Name] = FilledParameter.Input(newFrame);
        }
