...
namespace StatsDirect.UI
{
    class SDRegistry
    {
        ...
        public static bool SaveSetting(string app, string key, string valueName, string value)
        {
            try
            {
        ...
        /// <returns></returns>
        public static string GetStringSetting(string app, string key, string valueName, bool getFromMachine)
        {
            try
            {
        ...
        /// <param name="getFromMachine"></param>
        /// <returns></returns>
        public static int? GetDwordSetting(string app, string key, string valueName, bool getFromMachine)
        {
            try
            {
                using RegistryKey root = getFromMachine ? Registry.LocalMachine : Registry.CurrentUser,
