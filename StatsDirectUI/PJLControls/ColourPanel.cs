...
namespace StatsDirect.PJLControls
{
    ...
    public class ColorPanel : UserControl
    {
        ...
        {
            private readonly int unsorted_index;
            ...
            private ColorWellInfo(Color color, int unsortedIndex, bool isCustomWell)
            {
                IsCustomWell = isCustomWell;
                this.color = color;
                distance = color.R * color.R + color.B * color.B + color.G * color.G;
            ...
            private static IComparer CompareColorDistance()
            {
            ...
            /// </summary>
            /// <returns>IComparer</returns>
            private static IComparer CompareColorName()
            {
            ...
            /// </summary>
            /// <returns>IComparer</returns>
            private static IComparer CompareColorSaturation()
            {
            ...
            /// </summary>
            /// <returns>IComparer</returns>
            private static IComparer CompareColorHue()
            {
            ...
            /// </summary>
            /// <returns>IComparer</returns>
            private static IComparer CompareColorBrightness()
            {
            ...
            /// </summary>
            /// <returns>IComparer</returns>
            private static IComparer CompareUnsorted()
            {
            ...
            /// <param name="lastWellIsCustom"> </param>
            /// <returns></returns>
            public static ColorWellInfo[] GetCustomColorWells(Color[] customColors, ColorSortOrder colorSortOrder, bool lastWellIsCustom)
            {
                ...
                {
                    colorWells[i] = new ColorWellInfo(customColors[i], i, lastWellIsCustom && i == customColors.Length - 1);
                }
            ...
            public static void SortColorWells(ColorWellInfo[] colorWells, ColorSortOrder colorSortOrder)
            {
                ...
                switch (colorSortOrder)
                {
                    case ColorSortOrder.Brightness:
                        Array.Sort(colorWells, CompareColorBrightness());
                        break;
                    case ColorSortOrder.Distance:
                        Array.Sort(colorWells, CompareColorDistance());
                        break;
                    case ColorSortOrder.Hue:
                        Array.Sort(colorWells, CompareColorHue());
                        break;
                    case ColorSortOrder.Name:
                        Array.Sort(colorWells, CompareColorName());
                        break;
                    case ColorSortOrder.Saturation:
                        Array.Sort(colorWells, CompareColorSaturation());
                        break;
                    case ColorSortOrder.Unsorted:
                        Array.Sort(colorWells, CompareUnsorted());
                        break;
                }
            }
            ...
            /// <param name="isCustomWell"> </param>
            public void DrawColorWell(Graphics g, bool enabled, bool selected, bool pickColor, bool isCustomWell)
            {
                if (!enabled)
                {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            foreach (ColorWellInfo c in colorWells)
            {
                c.DrawColorWell(e.Graphics, Enabled, c == currentColor, c == pickColor, c.IsCustomWell);
            }
        ...
        public Color CustomColor
        {
            ...
            set
            {
                ...
                {
                    customColor = value;
                    foreach (ColorWellInfo well in colorWells)
                        if (well.IsCustomWell)
                            well.ForceColor(value);
                    Refresh();
                }
            }
        }
        ...
        private void UpdatePickColor(Color c)
        {
            ...
            if (null == pickColor && lastWellIsCustom)
            {
                foreach (ColorWellInfo well in colorWells)
                    if (well.IsCustomWell)
                    {
        ...
        /// <summary>
        /// If true, the last custom element's colour can be changed.
        /// </summary>
        [Browsable(true)]
        [Category("ColorPanel")]
        ...
        public bool LastWellIsCustom
        {
            ...
            set
            {
                ...
                {
                    colorWells = ColorWellInfo.GetCustomColorWells(customColors, colorSortOrder, LastWellIsCustom);
                }
            }
        }
        ...
        public int Columns
        {
            ...
            set
            {
                if (value > 0)
                {
                    preferredColumns = value <= colorWells.Length ? value : colorWells.Length;
                }
                else
                {
                    preferredColumns = 0;
        ...
        {
            return ShouldSerializeCustomColors(customColors);
        }
