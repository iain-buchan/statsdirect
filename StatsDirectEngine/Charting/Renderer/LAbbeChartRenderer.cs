...
namespace StatsDirect.Charting.Renderer
{
    class LAbbeChartRenderer : AbstractXYZChartRenderer, IChartRenderer
    {
        ...
        ParameterBag IChartRenderer.Plot(ITemplateHost host, bool isForReturnedParametersOnly)
        {
            ...
            PlotXYZ(x, y, w, 1, options.k, "control percent", "experimental percent", "L'Abbe plot (symbol size represents sample size)", false, 0, host.ChartPreferences.MarkerTypes[0], options.rmh);
            return new ParameterBag();
        }
    }
}
