...
namespace StatsDirect.Charting.Renderer
{
    internal class NormalChartRenderer : AbstractXYChartRenderer, IChartRenderer
    {
        ...
        {
            return PlotNormal(host.ChartPreferences, ((DoubleSeries)Definition.XSeries[0]).Data, isForReturnedParametersOnly);
        }
        ...
        ///  </summary>
        ///  <remarks></remarks>
        internal ParameterBag PlotNormal(IChartPreferences chartPreferences, double[] y, bool isForReturnedParametersOnly)
        {
            NormalOptions nOptions = (NormalOptions)Definition.ChartOptions;
            NormalOptions.ScoreMethod method = nOptions.Method;
