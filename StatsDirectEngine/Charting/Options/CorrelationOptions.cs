...
namespace StatsDirect.Charting
{
    ...
    public class CorrelationOptions : GenericOptions
    {
        ...
        public CorrelationOptions(IChartPreferences chartPreferences, int k, string[] titles, double[] odr, double[] odrl, double[] odru, double[] gn, CorrelationRowType[] pg, string cap, string qid, Transformation xform, bool isDifference)
