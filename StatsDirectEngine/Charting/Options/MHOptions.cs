...
namespace StatsDirect.Charting
{
    ...
    public class MHOptions : ForestishOptions
    {
        ...
        public MHOptions(IChartPreferences chartPreferences, int lowerBound, int k, IList<double> odw, IList<string> titles, double rmh, double ll, double ul, double cco, IList<double> odr, IList<double> odrl, IList<double> odru, IList<bool> lerr, IList<bool> uerr, bool[] included, string cap, int pbias, string qid)
