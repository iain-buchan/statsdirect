...
namespace StatsDirect.Charting
{
    ...
    public class KaplanMeierOptions : GenericOptions
    {
        ...
        public KaplanMeierOptions(IChartPreferences chartPreferences, int[,] dead, int groups, int[] cnx, string[] groupLabels, bool drawTics, bool useMarkers, double[,] x, double[,] y, KaplanMeierPlotMode plotMode, string xAxisTitle, string yAxisTitle, string title)
