...
namespace StatsDirect.Charting
{
    ...
    public static class ChartRendererFactory
    {
        ...
        public static ChartDefinition PrepForLater(IChartPreferences chartPreferences, ChartType chartType, ChartOptions options)
        {
            return PrepForLater(chartPreferences, chartType, options, null, null);
        }

        public static ChartDefinition PrepForLater(IChartPreferences chartPreferences, ChartType chartType, ChartOptions options, DoubleSeries xSeries, DoubleSeries ySeries)
        {
            ChartDefinition cd = new(chartPreferences) { ChartType = chartType, ChartOptions = options };
            if (null != xSeries)
