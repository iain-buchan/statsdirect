...
namespace StatsDirect.Builtins
{
    public static class Survival
    {
        ...
        public static StepOutput RptKaplanMeierPlots(IChartPreferencesHost host, ParameterBag parameters)
        {
            ...
            IList<IRenderable> imageList = x_plgraph(host.ChartPreferences, h, s, stime, dead, groups, cnx, glab, useTics, useMarkers);
        ...
        public static IList<IRenderable> x_plgraph(IChartPreferences chartPreferences, double[,] h, double[,] s, double[,] stime, int[,] dead, int groups, int[] cnx, string[] glab, bool tic, bool marker)
        {
            ...
            foreach (KaplanMeierPlotMode plotMode in new[] { KaplanMeierPlotMode.Survival, KaplanMeierPlotMode.Hazard, KaplanMeierPlotMode.LogHazard, KaplanMeierPlotMode.LognormalSurvival, KaplanMeierPlotMode.HazardRate })
            {
                ...
                outputImages.Add(ChartRendererFactory.PrepForLater(chartPreferences, ChartType.KaplanMeier, new KaplanMeierOptions(chartPreferences, dead, groups, outCnx, glab, tic, marker, x, y, plotMode, xAxisTitle, yAxisTitle, title)));
            }
            return outputImages;
        }
