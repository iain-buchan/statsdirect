    ...
    public static class Formula
    {
        ...
        public static StepOutput RptRandomBlock(ParameterBag parameters)
        {
            ...
            if (n / (double)t != Math.Floor(n / (double)t))
                throw new Templates.InvalidDataException("Number of subjects must be divisible by the number of treatments");
            ...
            if (!blockSizeIsRandom)
            {
                ...
                if (blockSize / (double)t != Math.Floor(blockSize / (double)t))
                    throw new Templates.InvalidDataException("Block size must be divisible by the number of treatments");
