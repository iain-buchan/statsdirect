...
namespace StatsDirect.Builtins
{
    ...
    public static class RegressRpt
    {
        ...
        public static StepOutput RptGroupedCovariance(IChartPreferencesHost host, ParameterBag parameters)
        {
            ...
            outputParameters.AddOutput("chart", ChartRendererFactory.PrepForLater(host.ChartPreferences, ChartType.Xyr, new XyrOptions(host.ChartPreferences, xt, y, k, nxi, ny, b, a, xlab, ylab, "Grouped Linear Regression", bnam, groupedCovarianceData.minMax)));
